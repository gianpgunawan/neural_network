...
int main(int argc, char **argv)
{
    ...
    // LAYERED MODEL
    NN_Layered new_model = {0}; nn_layered_init(&new_model);
    nn_layered_add_layer(&arena, &new_model, 2, relu.actv);
    nn_layered_add_layer(&arena, &new_model, 2, relu.actv);
    nn_layered_add_layer(&arena, &new_model, 1, sig.actv);
